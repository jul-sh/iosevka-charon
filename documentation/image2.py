...
# $ git clone my-font
# $ cd my-font
# $ uv run documentation/image2.py --output documentation/image2.png
...
# Find the first regular font in fonts/ttf/
FONT_PATTERN = "fonts/ttf/*/IosevkaCharon-Regular.ttf"
font_matches = glob.glob(FONT_PATTERN)
if not font_matches:
    print(f"ERROR: No font found matching pattern {FONT_PATTERN}", file=sys.stderr)
    sys.exit(1)
FONT_PATH = font_matches[0]
...
# For example: $ uv run documentation/image2.py --output documentation/image2.png
